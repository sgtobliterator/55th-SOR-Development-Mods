...
//   [ TYPE, [displayName, tooltip], controlArgs, forceDefault ]
// COMBO controlArgs = [VALUES, LABELS, DEFAULT_INDEX]   (NO pictures slot;
// pictures, if ever needed, go inside each LABELS entry). The value returned
// in onConfirm is the SELECTED VALUE (not the index).
private _content = [
    ["COMBO",
