...
class Extended_PreStart_EventHandlers
{
	class zen_common
	{
		init="call compileScript ['\x\zen\addons\common\XEH_preStart.sqf']";
	};
};
class Extended_PreInit_EventHandlers
{
	class zen_common
	{
		init="call compileScript ['\x\zen\addons\common\XEH_preInit.sqf']";
	};
};
class Extended_PostInit_EventHandlers
{
	class zen_common
	{
		init="call compileScript ['\x\zen\addons\common\XEH_postInit.sqf']";
	};
};
